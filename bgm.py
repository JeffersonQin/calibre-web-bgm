...
META_PROVIDER_BGM_THREAD_POOL = int(os.getenv("META_PROVIDER_BGM_THREAD_POOL", 8))
META_PROVIDER_BGM_TAG_LOWEST_USER_CNT = int(os.getenv("META_PROVIDER_BGM_TAG_LOWEST_USER_CNT", 5))
META_PROVIDER_BGM_TAG_MAX_CNT = int(os.getenv("META_PROVIDER_BGM_TAG_MAX_CNT", 10))
